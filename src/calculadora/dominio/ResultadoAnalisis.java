 ...
 * @param mensajeError Mensaje descriptivo si comando es ERROR; en caso
 *                     contrario puede ser null.
 */
public record ResultadoAnalisis(TipoComando comando, List<Double> numeros, List<TipoOperador> operadores,
		String mensajeError) {
